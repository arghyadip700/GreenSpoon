...
import zh from './all-img/Zero Hunger.jpg'
import dwf from './all-img/Dont Waste Food.jpg'
                ...
                <div className='feat'>
                    ...
                    <div className="row featurette" style={{ width: "100%" }}>
                        ...
                        <div className="col-md-5">
                            <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src={zh} alt="..."></img>
                        </div>
                    </div>
                    <hr className="featurette-divider" />
                    <div className="row featurette" style={{ width: "100%" }}>
                        ...
                        <div className="col-md-5 order-md-1">
                            <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src={dwf} alt="..."></img>
                        </div>
                    </div>
                    <hr className="featurette-divider" />
